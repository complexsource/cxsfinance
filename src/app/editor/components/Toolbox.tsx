...
import { LayoutTemplate, Type, MousePointerClick } from 'lucide-react'
  ...
  const components = [
    {
      ...
      color: 'blue',
      create: () => <EditableBanner heading="New Banner" subheading="Add your content here" />,
    },
    {
      name: 'Text',
      icon: Type,
  ...
  return (
    <div className="h-full overflow-auto">
      ...
      <div className="p-6 border-b border-gray-200 bg-gradient-to-r from-blue-50 to-purple-50 sticky top-0 z-10">
        ...
        <p className="text-sm text-gray-600">Drag components onto your page</p>
      </div>
      ...
      <div className="p-4 space-y-3">
        {components.map((component, index) => (
          <div
            ...
            ref={(ref) => {
              if (ref) {
                connectors.create(ref, component.create())
              }
            }}
            className="
          ...
          >
            ...
            <div className="flex items-start gap-3 ml-4">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-sm text-gray-600 leading-snug">{component.description}</p>
              </div>
            </div>
